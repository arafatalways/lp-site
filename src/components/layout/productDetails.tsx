...
const ProductDetails = () => {
  const products = [
    {
      name: "মায়াবতী ফ্লোরাল টপ + প্লাজ্জু ( ১ সেটের কম্বো ) মাত্র -",
      price: "৳ ১০৫০",
    },
    {
      name: "মায়াবতী ফ্লোরাল টপ + প্লাজ্জু ( ২ সেটের কম্বো ) মাত্র -",
      price: "৳ ১৯৫০",
    },
    {
      name: "মায়াবতী ফ্লোরাল টপ + প্লাজ্জু ( ৩ সেটের কম্বো ) মাত্র -",
      price: "৳ ২৯৫০",
    },
  ];
